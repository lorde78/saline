    ...
    return (
        <>
            {loader ? (
                <>
                    <Header />
                    <Header_section_page numberUndoPage={1} title={professor?.informations.firstName + " " + professor?.informations.firstName}/>
                    <main className={"max_width_container margin-top-20"}>
                        <div className={"main_section_container-flex margin-top-20 max_width"}>
                            <ProfessorInfos data={professor.informations}/>
                            <Accordion title="Les formations" content="Content 1" picto="ri-book-mark-line"/>
                            <p className="professor-biographie">{professor.informations.description}</p>
                        </div>
                    </main>
                    <Footer/>
                </>
