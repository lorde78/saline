...
const LanguageSelect: React.FC = () => {
    ...
    return (
        <div className="custom_select_container">
            <div className={`custom_select ${isOpen ? 'open' : ''}`} onClick={toggleDropdown}>
                <div className="selected_option">{selectedLanguage ? selectedLanguage.label : 'Select a country'}</div>
